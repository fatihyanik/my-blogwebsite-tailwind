function Sidebar() {
  return (
    <div className="flex-[3] m-5 pb-7 bg-slate-50 rounded-[10px] flex flex-col items-center">
      ...
      <div className="flex flex-col items-center">
        <span className="m-[10px] p-[5px] w-4/5 border-[1px] border-y-gray-700 text-[12px] text-black font-semibold leading-5 text-center">CATEGORIES</span>
      ...
      <div className="flex flex-col items-center">
        <span className="m-[10px] p-[5px] w-4/5 border-[1px] border-y-gray-700 text-[12px] text-black font-semibold leading-5 text-center">FOLLOW US</span>

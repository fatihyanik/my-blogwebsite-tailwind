  ...
  return (
    <div className="pt-[50px]">
      ...
      <form className="relative">
        ...
        <button className="absolute top-[20px] right-[50px] text-white bg-teal-700 p-[10px] border-none rounded-[10px] text-[16px] cursor-pointer flex items-center " type="submit">
          Publish
        </button>
      </form>
    </div>
